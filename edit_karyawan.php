            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form class="mb-5" action="./edit_karyawan_post.php" method="POST" id="appsform" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <input type="hidden" class="form-control" id="karyawanID" name="karyawanID" value="<?php echo $karyawan_id; ?>" autocomplete="off" required>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="karyawanNik">NIK</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="karyawanNik" name="karyawanNik" placeholder="Masukkan NIK" value="<?php echo $karyawan_nik; ?>" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="karyawanNama">Nama Lengkap</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="karyawanNama" name="karyawanNama" placeholder="Masukkan Nama Lengkap" value="<?php echo $karyawan_nama; ?>" autocomplete="off" minlength="2" maxlength="50" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="karyawanJabatan">Jabatan</label>
                                    <div class="col-sm-8">
                                        <select class="custom-select" id="karyawanJabatan" name="karyawanJabatan" autocomplete="off" required>
                                            <?php
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="custom-select" id="karyawanJK" name="karyawanJK" autocomplete="off" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control" id="karyawanTgl" name="karyawanTgl" value="<?php echo $karyawan_lahir; ?>" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="karyawanNohp">Nomor Telepon <small style="color:red">Contoh : 62822xxxx4496</small></label>
                                    <div class="col-sm-8">
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">+</div>
                                            </div>
                                            <input type="number" class="form-control" id="karyawanNohp" name="karyawanNohp" placeholder="Masukkan Nomor Telepon" value="<?php echo $karyawan_nomorhp; ?>" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea type="text" class="form-control" id="karyawanAlamat" name="karyawanAlamat" placeholder="Masukkan Alamat Lengkap" minlength="4" maxlength="500" autocomplete="off" required><?php echo $karyawan_alamat; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="karyawanFoto">Foto Karyawan</label>
                                    <div class="col-sm-7">
                                        <img src="./image/<?php echo $karyawan_foto; ?>" style="width: 120px;float: left;margin-bottom: 10px;">
                                        <input type="file" class="form-control-file" id="karyawanFoto" name="karyawanFoto" autocomplete="off" accept="image/*">
                                    </div>
                                </div>
                                <div class="form-group row">
