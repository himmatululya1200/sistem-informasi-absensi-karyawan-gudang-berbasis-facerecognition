...
if (isset($_POST)) {
    ...
    if ($updateKaryawanFoto) {
        ...
        $sql = "UPDATE `karyawan` 
                SET `jabatan_id` = '$karyawanJabatan' =  `karyawan_nama` = '$karyawanNama', `karyawan_nik` = '$karyawanNIK', `karyawan_jeniskelamin` = '$karyawanJenisKelamin', `karyawan_lahir` = '$karyawanTanggalLahir', `karyawan_nomorhp` = '$karyawanNohp', `karyawan_alamat` = '$karyawanAlamat', `karyawan_foto` = '$response'
                WHERE `karyawan`.`karyawan_id` = '$karyawanID';";
    }else{
        $sql = "UPDATE `karyawan` 
                SET `jabatan_id` = '$karyawanJabatan' =  `karyawan_nama` = '$karyawanNama', `karyawan_nik` = '$karyawanNIK', `karyawan_jeniskelamin` = '$karyawanJenisKelamin', `karyawan_lahir` = '$karyawanTanggalLahir', `karyawan_nomorhp` = '$karyawanNohp', `karyawan_alamat` = '$karyawanAlamat'
                WHERE `karyawan`.`karyawan_id` = '$karyawanID';";
    }
