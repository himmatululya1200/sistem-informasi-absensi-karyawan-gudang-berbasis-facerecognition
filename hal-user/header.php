            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link <?php echo ($page == 'Dashboard') ? "active" : "" ?>" href="/hal-user/dashboard-user.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Dashboard
                        </a>

                        <a class="nav-link <?php echo ($page == 'Data Rekap') ? "active" : "" ?>" href="/hal-user/data-rekap.php">
