...
if (isset($_POST)) {
    ...
    $sql = "INSERT INTO `karyawan` (`karyawan_id`, `jabatan_id`, `face_id`, `karyawan_nik`, `karyawan_jeniskelamin`, `karyawan_lahir`, `karyawan_nomorhp`, `karyawan_alamat`, `karyawan_foto`, `karyawan_status`) 
            VALUES (NULL, '$karyawanJabatan', '$karyawanNama', '$karyawanNIK', '$karyawanJenisKelamin', '$karyawanTanggalLahir', '$karyawanNohp', '$karyawanAlamat', '$response', '1');";
    if($koneksi->query($sql) === TRUE)
    {
        $qryUpdate = "UPDATE nik SET used=1 WHERE nike='$karyawanNIK'";
