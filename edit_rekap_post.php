...
if (isset($_POST)) {
    ...
    if($rekapStatus != "Hadir Masuk" && $rekapStatus != "Hadir Pulang" && $rekapStatus != "Terlambat" && $rekapStatus != "Alpa")
    {
        die(json_encode(array(
            'status' => false, 
    ...
    $sql = "UPDATE `absensi` SET `status` = '$rekapStatus' WHERE `absensi`.`id` = '$rekapID';";
